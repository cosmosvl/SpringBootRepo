...
// Using @Entity annotation, we convert the DTO (Data Transfer Object) into JPA Entity.
// JPA = Java Persistence API
@Entity
public class Shipwreck {
	
	// The @ID annotation tells JPA that "id" is the primary key and how its generated.
	@Id
